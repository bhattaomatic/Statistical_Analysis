...
Check for different values of reflected path in case of a specific direct path signsl.
...
td = 0.0					# Direct path signal.
tr = np.arange(0,1,0.01)		# The reflected path signal.
