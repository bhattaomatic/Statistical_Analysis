...
plt.xlabel('Filter Taps', fontsize=32)
plt.ylabel('Amplitude', fontsize=32)
plt.title('Time Domain Absolute Channel Impulse Response', fontsize=32)
...
plt.xlabel('Filter Taps', fontsize=32)
plt.ylabel('Amplitude', fontsize=32)
plt.title('Time Domain IQ Channel Impulse Response', fontsize=32)
plt.show()
